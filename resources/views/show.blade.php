                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="input-group mt-0">
                                            <input type="button" name="adultos-minus" value="-" class="button-minus"
                                                data-field="adultos">
                                            <input type="" step="1" Xmax="12" value="1"
                                                name="adultos" class="adultos-field" onchange="calculateTotal()">
                                            <input type="button" name="adultos-plus" value="+" class="button-plus"
                                                data-field="adultos">
                                        </div><br>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="input-group mt-0">
                                            <input type="button" name="menores-minus" value="-" class="button-minus"
                                                data-field="menores">
                                            <input type="" step="1" Xmax="12" value="0"
                                                name="menores" class="menores-field" onchange="calculateTotal()">
                                            <input type="button" name="menores-plus" value="+" class="button-plus"
                                                data-field="menores">
                                        </div><br>
                                    </div>
                                    ...
                                    <div class="box-precio">
                                        <div class="row">
                                            <div class="col-md-6 col-12 text-center">
                                                ...
                                                <div>
                                                    <span>USD </span><span
                                                        class="total_reserva">{{ $show->precio }}</span>.-
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12 text-center">
                                                <button type="submit"
                                                    class="btn btn-reservar">@lang('trans.RESERVAR')</button>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
		...
		$('.datespicker').datepicker({
		    ...
		    beforeShowDay: function(date) {
		        ...
		        var day = date.getDay();
		        // Mostrar solo los días viernes y sábados
		        if (day === 5 || day === 6) {
		            return [true, ''];
		        } else {
		            return [false, ''];
