...
<head>
    ...
    <meta name="description"
        content="Reserva tu lugar en Cátulo Tango Show y disfruta de una noche mágica de tango y cena en Buenos Aires. Conoce a los mejores bailarines y músicos del auténtico tango argentino.">
    <meta name="keywords"
        content="catulo tango, catulo tango show, espectáculo de tango, cena show de tango, buenos aires, tango argentino, catulo tango, catulo tango show, tango show, dinner tango show, tango show ba, cena show de tango, buenos aires, tango">
    ...
    <script>
        ...
        gtag('js', new Date());
        gtag('config', 'G-ZB1SNCGBVT');
    </script>

    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-11132556556"></script>;
    <script>
        window.dataLayer = window.dataLayer || [];
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <a data-bs-dismiss="modal" class="close-modal" href=""><i
                        ...
                        <div class="bd sm2-playlist-drawer sm2-element">
                            ...
                            <div class="sm2-playlist-wrapper">
                                <ul class="sm2-playlist-bd">
                                    <li><a href="{{ asset('Libertango-By-EstebanMorgando.mp3') }}">Libertango by
                                            Esteban Morgado</a></li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function initialize() {
            ...
            window.map2 = new google.maps.Map(document.getElementById('google-map2'), {
                ...
                center: {
                    lat: -34.601705669366524,
                    lng: -58.409403001998136
                },
                zoom: 12
        ...
        function loadScript() {
            ...
            script.src =
                'https://maps.googleapis.com/maps/api/js?key=AIzaSyBBhh9bdv02x8XPknaSceyUsPFrz6ap4SE&sensor=false&' +
                'callback=initialize';
